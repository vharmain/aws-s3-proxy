...
Forked from https://github.com/pottava/aws-s3-proxy The difference is that this fork attempts to be more HTML5-routing friendly with rewrites to index.html whenever necessary.  
